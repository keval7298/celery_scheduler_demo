...
from app.core.const import TaskRunStatus, description_length, name_length, now
from app.core.database import Base, with_session
from app.core.sqlalchemy_utils import CRUDMixin, TruncateString
...
class TaskRunRecord(CRUDMixin, TruncateString("error_message"), Base):
